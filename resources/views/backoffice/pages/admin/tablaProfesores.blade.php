...
@section('breadcrumbs')
    <li>
        <div class="flex items-center">
            ...
            <a href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Tabla profesores</a>
        </div>
    </li>
@endsection
        ...
        @foreach($profesores as $p)
			<tr class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
				...
				<td class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                    ...
                    <a target="_blank" href="/storage/{{$p->email}}/{{$p->cv}}">
					<button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 border border-blue-500 rounded">Ver-CV</button>
                    </a>
