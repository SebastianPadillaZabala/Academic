    ...
    <nav class="flex flex-col bg-indigo-600 w-64 h-full px-12 pt-0 pb-6  overflow-y-auto">
        <div>
            ...
            <li>
                ...
                <a href="{{route('admin.dashboard')}}" class="relative px-4 py-2 flex items-center space-x-2 rounded-xl text-white group">
           ...
           <li>
            ...
            <li>
                <a href="{{route('Allprofesores')}}" class="px-4 py-2 flex items-center space-x-3 rounded-md text-white group">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
