...
<section class="bg-gray-100"> 
	...
	<div class="max-w-full md:max-w-6xl mx-auto my-3 md:px-8">
		...
		>
		<div
		class="bg-white text-black rounded-lg shadow-inner shadow-lg overflow-hidden transform transition-all hover:-translate-y-4"
		>
		<div
...
<div class="block flex items-center p-8  uppercase">
	...
	bg-indigo-500 w-full text-white rounded-lg 
...
<div
class="w-full max-w-md sm:w-2/3 lg:w-1/3 sm:my-5 my-8 relative z-10 bg-white rounded-lg shadow-lg transform transition-all hover:-translate-y-4"
>
<div
class="text-sm leading-none rounded-t-lg bg-gray-400 text-black font-semibold uppercase py-4 text-center tracking-wide"
>
Most Popular
</div>
<div
