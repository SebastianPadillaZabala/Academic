            ...
            <div class="flex flex-col md:flex-row md:justify-between md:items-center">
                ...
                <div class="items-center md:flex">
                    ...
                    <div class="flex items-center py-2 -mx-1 md:mx-0">
                        ...
                        <a class="block w-1/2 px-3 py-2 mx-1 text-sm font-medium leading-5 text-center text-white transition-colors duration-200 transform bg-indigo-500 rounded-md hover:bg-indigo-600 md:mx-0 md:w-auto" href="{{ route('reg') }}">Registrarse</a>
                    </div>
