...
<div>
<div class="px-10 py-20 bg-gray-50 grid gap-10 lg:grid-cols-3 xl:grid-cols-4 sm:grid-cols-2">
  @foreach($cursos as $c)
    <div class="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
      ...
      <h1 class="mt-4 text-gray-800 text-2xl font-bold cursor-pointer">"{{$c->name}}"</h1>
      <div class="my-4">
