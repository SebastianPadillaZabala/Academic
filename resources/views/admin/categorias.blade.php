...
<a class="inline-flex text-xl items-center h-8 px-2 m-4 text-sm text-indigo-100 transition-colors duration-150 bg-indigo-600 rounded-md focus:shadow-outline hover:bg-indigo-800" href="#">Añadir Categoria</a>
